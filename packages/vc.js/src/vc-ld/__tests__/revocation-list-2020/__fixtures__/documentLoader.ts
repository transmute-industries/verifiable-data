...
const contextResolver = async (iri: string) => {
  ...
  if (iri === 'did:key:z6MkfJSbaRjStEZWd8KiV2zUSfnEXnFX5iviaLe1ArMTkNXF#z6MkfJSbaRjStEZWd8KiV2zUSfnEXnFX5iviaLe1ArMTkNXF') {
    return {
      document: {
        "@context": [
        ...
        "verificationMethod": [
          {
            "id": "did:key:z6MkfJSbaRjStEZWd8KiV2zUSfnEXnFX5iviaLe1ArMTkNXF#z6MkfJSbaRjStEZWd8KiV2zUSfnEXnFX5iviaLe1ArMTkNXF",
            "type": "JsonWebKey2020",
            "controller": "did:key:z6MkfJSbaRjStEZWd8KiV2zUSfnEXnFX5iviaLe1ArMTkNXF",
            "publicKeyJwk": {
              "kty": "OKP",
              "crv": "Ed25519",
          ...
          {
            "id": "did:key:z6MkfJSbaRjStEZWd8KiV2zUSfnEXnFX5iviaLe1ArMTkNXF#z6LShh513ABHh6V4JhAjuhcQCXGethoWrxcWRgfDfbhkJZfS",
            "type": "JsonWebKey2020",
            "controller": "did:key:z6MkfJSbaRjStEZWd8KiV2zUSfnEXnFX5iviaLe1ArMTkNXF",
            "publicKeyJwk": {
              "kty": "OKP",
  ...
  if (iri === 'http://localhost:8080/credentials/489ccb71-9352-44f8-ba4e-a8b6f03c44a0') {
    return {
      document: {
        "@context": [
        ...
        "id": "http://localhost:8080/credentials/489ccb71-9352-44f8-ba4e-a8b6f03c44a0",
        "type": [
          "VerifiableCredential",
          "RevocationList2020Credential"
        ],
        "credentialSubject": {
          "id": "http://localhost:8080/credentials/489ccb71-9352-44f8-ba4e-a8b6f03c44a0#list",
          "type": "RevocationList2020",
          "encodedList": "H4sIAAAAAAAAA-3BIQEAAAACIP1_2hcmoAEAAAAAAAAAAAAAAPgbF0EzbtQwAAA"
        },
        "issuer": {
          "id": "did:key:z6MkfJSbaRjStEZWd8KiV2zUSfnEXnFX5iviaLe1ArMTkNXF"
        },
        ...
        "proof": {
          ...
          "jws": "eyJhbGciOiJFZERTQSIsImI2NCI6ZmFsc2UsImNyaXQiOlsiYjY0Il19..QzqJzzT4UFSfKJRDC22c6kRAg-H56dRQkJLIro0JBpWXhly1WaG4DVYqOtXN04VzJHFoyeC-nJgioOJmpApoDA"
        }
      }
    }
  }
