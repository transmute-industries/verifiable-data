...
import { issuedOn, createCredential, createSuite, signCredential, isDateValidXmlSchema } from './date-utils'
...
describe('Handling irregular date value provided into suite', () => {
    ...
    it('should create suite with an undefined date', async () => {
        ...
        credential.issuanceDate = issuedOn;
        ...
        expect(isDateValidXmlSchema(undefinedSuiteFixture.proof.created)).toBeTruthy();
    });
    ...
    it('should create suite with an empty string date', async () => {
        ...
        // Both Transmute and Digital Bazaar should have valid dates
        expect(isDateValidXmlSchema(proof.created)).toBeTruthy();
        expect(isDateValidXmlSchema(emptyStringSuiteFixture.proof.created)).toBeTruthy();
