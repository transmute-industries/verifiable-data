...
const credential1 = require("../credentials/credential-1.json");
const proof = require("../vectors/credential-1--key-0.json");
...
const createCase = async () => {
  ...
  const tampered1 = JSON.parse(JSON.stringify(credential1));
  ...
  const tampered2 = JSON.parse(JSON.stringify(credential1));
  ...
  const vectorName = "credential-1--key-0--check";
