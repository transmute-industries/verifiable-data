...
afterAll(()=>{
  fs.writeFileSync('merkle-tree.md', `## Merkel Tree URN
\`\`\`
${fullTreeUrn}
\`\`\`
...
fs.writeFileSync('merkle-proof.md', `## Merkel Proof URN
\`\`\`
${singleProofUrn}
\`\`\`
...
fs.writeFileSync('merkle-combined.md', `## Merkel Proof Review
${combinedMermaid}
`)
})