...
`
  ...
  return `\t\t${n.id}("${n.label}")\n`
    ...
    linkStyle: (e: any, i:number) => {
      if (e.target === 'c478fead0c89b79540638f844c8819d9a4281763af9272c7f3968776b6052345'){
...
`
  ...
  fs.writeFileSync('./src/mermaid-representation/__tests__/custom.tree.mermaid.md', fullTreeMermaid)
})